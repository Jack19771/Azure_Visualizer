"""
Django settings for terraform_builder project.
...
SECRET_KEY = 'django-insecure-+#ibebje=fcnfzi0lh&_el+tf=7gp)q0+*-#68qkb%(ydjiq9^'
...
ROOT_URLCONF = 'terraform_builder.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # <-- ZMIEŃ TĘ LINIĘ
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'terraform_builder.wsgi.application'
